...
So, I tried to have the program load scriptures from a file.
*/
...
class Program
{
    ...
    // This part of the program is to display choices to user
    {
        Reference reference = new Reference();
...
What would you like to do?  ";
        ...
        userInput.ToLower();
        int userChoice = 0;
        // This part of the program catches any non integer values that are entered
        try
        {
