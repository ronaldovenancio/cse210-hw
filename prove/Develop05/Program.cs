/* Add additional kinds of goals, 
"negative goals" where they lose points for bad habits.
I created a NegativeGoals.cs that decrease the points but it is necessary to put negative numbers in points. 
*/
using System;
using System.IO;
